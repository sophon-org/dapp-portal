...
.prividium-auth-modal {
  ...
  .auth-steps {
    ...
    .step {
      ...
      &.active {
        @apply border-primary-400 dark:border-primary-400 dark:bg-primary-400/10 bg-neutral-50;
      }
      ...
      .step-indicator {
        ...
        .active & {
          @apply bg-primary-400 dark:bg-primary-400 text-white;
        }
  ...
  .action-section {
    ...
    .auth-button {
      ...
      &.primary {
        @apply bg-primary-400 hover:bg-primary-700 text-white disabled:cursor-not-allowed disabled:bg-neutral-300 dark:disabled:bg-neutral-700;
      }
