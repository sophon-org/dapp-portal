<template>
  <CommonModal v-model:opened="modalOpened" title="Network switched" @after-leave="afterModalLeave">
    <p class="leading-normal">
      ...
      to
      <span class="font-medium">{{ selectedNetwork.name }}</span> since your last use of Sophon Portal.
    </p>
    ...
    <div class="mt-4 flex flex-col items-center">
      ...
      <CommonButton size="lg" variant="primary" class="w-full" @click="closeModal">
