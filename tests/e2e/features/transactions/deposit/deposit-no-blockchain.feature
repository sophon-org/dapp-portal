...
Feature: Deposit
  ...
  Scenario: Where to add funds - Receive - [WF] Check for Mistakes
    ...
    When I fill the input field contains "placeholder" type "Address, Soph.id or ENS or contact name" value with "0x8f0f44583aQ6908f7f933cd6f0aae382ac3fd8f6" text
    Then Element with "text" "Please enter a valid Ethereum address" should be "visible"  
    When I fill the input field contains "placeholder" type "Address, Soph.id or ENS or contact name" value with "0x8f0f44583a6908f7f933cd6f0aae382ac3fd8f6" text
    Then Element with "text" "Please enter a valid Ethereum address" should be "visible" 
    When I fill the input field contains "placeholder" type "Address, Soph.id or ENS or contact name" value with "0x8f0f44583a116908f7f933cd6f0aae382ac3fd8f6" text
    Then Element with "text" "Please enter a valid Ethereum address" should be "visible"  
    When I fill the input field contains "placeholder" type "Address, Soph.id or ENS or contact name" value with "0x8f0f44583a$6908f7f933cd6f0aae382ac3fd8f6" text
    Then Element with "text" "Please enter a valid Ethereum address" should be "visible"  
    When I fill the input field contains "placeholder" type "Address, Soph.id or ENS or contact name" value with "0x8f0F33583a56908F7F933cd6F0AaA382aC3fd8f6" text
    Then Element with "text" "Please enter a valid Ethereum address" should be "visible"
    When I fill the input field contains "placeholder" type "Address, Soph.id or ENS or contact name" value with "1231231231212312312314235346454756745635345345345399" text 
    Then Element with "placeholder" "Address, Soph.id or ENS or contact name" should have "12312312312123123123142353464547567456353453453453" "value"
