<template>
  ...
  <template v-if="routes">
    <div v-for="route in routes" :key="route.id" class="my-1.5">
      <div
        class="hover:border-gray-500 flex cursor-pointer items-center gap-4 rounded-2xl bg-neutral-200 px-2 py-4 hover:bg-neutral-300 dark:bg-neutral-900 dark:hover:bg-neutral-700/80"
      ...
      >
        ...
        <div>
          <ChevronRightIcon class="text-gray-700 h-6 w-6 dark:text-white" />
        </div>
      </div>
    </div>
  </template>
